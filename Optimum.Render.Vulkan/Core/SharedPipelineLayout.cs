...
internal sealed unsafe class SharedPipelineLayout : IDisposable
{
    ...
    public SharedPipelineLayout(VulkanContext context, DescriptorSetLayout textureSetLayout)
    {
        ...
        var frameBindings = new DescriptorSetLayoutBinding[1 + SetConvention.FrameTextures.Length];
        ...
        {
            frameBindings[1 + i] = new DescriptorSetLayoutBinding
            {
        ...
        var storageBindings = new DescriptorSetLayoutBinding[SetConvention.StorageBuffers.Length];
        for (int i = 0; i < storageBindings.Length; i++)
        {
            storageBindings[i] = new DescriptorSetLayoutBinding
            {

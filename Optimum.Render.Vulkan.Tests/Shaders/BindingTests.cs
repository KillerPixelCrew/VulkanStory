// Source: Optimum.Render.Vulkan.Tests/FrameGlobalsDeviceTests.cs
...
public class FrameGlobalsDeviceTests(ITestOutputHelper output)
{
    ...
    public void AFrameTextureADrawDoesNotNameIsReadableAfterBeingAnAttachment()
    {
        ...
        {
            VulkanDevice seam = device!;
            int reader = GpuTest.LinkProgram(seam, FullscreenVertex, """
                #version 330 core
            ...
            int depthWriter = GpuTest.LinkProgram(seam, FullscreenVertex, """
                #version 330 core
                out vec4 outColor;
...
// Source: Optimum.Render.Vulkan.Tests/SharedPipelineLayoutDrawTests.cs
namespace Optimum.Render.Vulkan.Tests
{
using System;
using Optimum.Render.Vulkan.Core;
...
public class SharedPipelineLayoutDrawTests
{
    ...
    public void TwoProgramsWithDifferentSamplersAlternateInOnePassWithoutRebindingSetsZeroAndOne()
    {
        ...
        {
            VulkanDevice seam = device!;
            int single = GpuTest.LinkProgram(seam, FullscreenVertex, """
                #version 330 core
                ...
                """, "shared-single");
            int pair = GpuTest.LinkProgram(seam, FullscreenVertex, """
                #version 330 core
    ...
    public void TransientRebindsAndFeedbackCopiesSampleThePhysicalTexture(bool aliasing)
    {
        ...
        using (seam)
        {
            ...
            int copy = GpuTest.LinkProgram(seam, FullscreenVertex, """
                ...
                """, "shared-copy");
            int feedback = GpuTest.LinkProgram(seam, FullscreenVertex, """
                #version 330 core

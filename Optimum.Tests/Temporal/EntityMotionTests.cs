// Source: Optimum.Tests/taa-entity-motion-coverage-tests.cs
...
public class TaaEntityMotionCoverageTests
{
    ...
    public void TheFrameContractTracksWhichViewTheLoadedProjectionBelongsTo()
    {
        ...
        Assert.Contains("frame.GetPrevProjection(view)",
            Read("sources/VintagestoryApi/Client/Render/OptimumTemporalMotion.cs"));
    }
...
// Source: Optimum.Tests/taa-standard-motion-coverage-tests.cs
namespace Optimum.Tests
{
using System;
using System.IO;

// Source: Optimum.Tests/Temporal/ContractTests.cs
...
public class TemporalContractTests
{
    ...
    public void TheContractDocumentIsVersionedAndComplete()
    {
        ...
        Assert.True(doc.Contains("Optimum.Tests/Temporal/ContractTests.cs", StringComparison.Ordinal),
    ...
    private static void AssertSetsMatch(string[] expected, string[] actual, string typeName, string listName)
    {
        ...
        string message =
            ...
            + $"{listName} in Optimum.Tests/Temporal/ContractTests.cs with the actual list below.\n"
...
// Source: Optimum.Tests/temporal-conventions-tests.cs
namespace Optimum.Tests
{
using System;
using Vintagestory.API.Client;

// Source: Optimum.Tests/installer-path-normalization-tests.cs
...
// Source: Optimum.Tests/installer-release-coverage-tests.cs
namespace Optimum.Tests
{
using System;
...
public class InstallerReleaseCoverageTests
{
    ...
    public void LinuxPrerequisiteShellTestsPass()
    {
        ...
        using Process process = Process.Start(new ProcessStartInfo(TestToolchain.Bash, script)
        {
    ...
    public void BashRuntimeDonorPatchGateRejectsPartialCompatibility()
    {
        ...
        try
        {
            ...
            ProcessStartInfo startInfo = new(TestToolchain.Bash)
            {
                RedirectStandardOutput = true,
                RedirectStandardError = true,
                UseShellExecute = false

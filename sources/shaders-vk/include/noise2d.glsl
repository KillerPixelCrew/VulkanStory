// Native port of the game include noise2d.ash (docs/vulkan.md section 1).
// optimum-port-of: noise2d.ash
...
#ifndef OPTIMUM_INCLUDE_NOISE2D_GLSL
#define OPTIMUM_INCLUDE_NOISE2D_GLSL

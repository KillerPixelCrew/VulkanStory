...
// Native port of blit.vsh (docs/vulkan.md).
...
#extension GL_EXT_scalar_block_layout : require
#extension GL_GOOGLE_include_directive : require
// Native port of blit.fsh (docs/vulkan.md).
#include "bindings.glsl"
#include "frame.glsl"
#include "specialization.glsl"
#else
...
// Program interface of blit (docs/vulkan.md section 4). A fullscreen pass: one draw per
